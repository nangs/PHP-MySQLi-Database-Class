...
class MysqliDb
{
     ...
     * @return MysqliDb Returns the current instance or creates one if it is not present.
     */
     ...
     * Added for consistency as default output type
     *
     * @return MysqliDb
     */
     ...
     * @param mixed $customFieldsOrRegExp Array with field set for ORDER BY FIELD() ordering or string with regular expression for ORDER BY REGEXP ordering
     *
     * @throws Exception
     * @return MysqliDb
     */
    ...
    public function lock($table)
    {
        ...
        if($result) {
            // Return true
            // We can't return our self because if one table gets locked, all other ones get unlocked!
            return true;
        }
    ...
    /**
     * Method creates new MysqliDb object for a sub query generation
     *
    ...
    /**
     * Method returns a copy of a MysqliDb sub query object
     *
